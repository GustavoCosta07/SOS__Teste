                ...
                <div id="customerList">
                    <div class="row g-4 mb-3">
                        <div class="col-sm-auto">
                            <div>
                                <a href="listar_produtos"><i class="ri-arrow-left-line"></i>&nbspVoltar</a>
                            </div>
                        </div>
                        <div class="col-sm">
                            <div class="d-flex justify-content-sm-end">
                                <form method="post" action="listar_unico_produto" id="form_busca">
                    ...
                    <div class="table-responsive table-card mt-3 mb-1">
                        <table class="table align-middle table-nowrap" id="customerTable">
                            ...
                            <tbody class="list form-check-all">
                                ...
                                $sql = "SELECT * FROM produtos WHERE produto_lixeira ='1' AND produto_nome LIKE '%$_POST[produto]%'  ORDER BY produto_nome";
                                // Executando $sql e verificando se tudo ocorreu certo.
                                $resultado = mysqli_query($conn, $sql);
                                //Realizando um loop para exibi&ccedil;&atilde;o de todos os dados 
                                $registros = mysqli_fetch_all($resultado);
                                if(mysqli_num_rows($resultado) > 0 && isset($_POST['produto'])){
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="status">
                                            ...
                                            <a href="edit_produtos/<?php echo $linha[0] ?>" class="link-success fs-15"><i class="ri-edit-2-line"></i></a>
