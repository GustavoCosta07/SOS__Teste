...
@$conn->query("update equipamentos set equipamento_nome = '$_POST[nome]', equipamento_id_marca = '$_POST[marca]', equipamento_modelo = '$_POST[modelo]' , equipamentos_paradas = '$_POST[paradas]' , equipamentos_porta = '$_POST[porta]'
                                                            ...
                                                            <div class="modal-body text-center p-5">
                                                                ...
                                                                <div class="mt-4">
                                                                    ...
                                                                    <div class="hstack gap-2 justify-content-center">
                                                                        ...
                                                                        <a href="edit_equipamentos/<?php echo $_POST[id] ?>" class="btn btn-success">Fechar</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
