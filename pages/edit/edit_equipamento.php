...
@$conn->query("update equipamentos set equipamento_nome = '$_POST[nome]', equipamento_modelo = '$_POST[modelo]', equipamentos_paradas = '$_POST[paradas]',
equipamento_id_marca = '$_POST[marca2]', equipamentos_porta= '$_POST[porta]', equipamento_status = '$_POST[status]'
