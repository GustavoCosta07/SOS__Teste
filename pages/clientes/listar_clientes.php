                        ...
                        <table class="table align-middle table-nowrap" id="customerTable">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th class="sort" data-sort="phone">CPF/CNPJ</th>
                                    <th class="sort" data-sort="phone">Equipamentos</th>
...
$sql2 = "SELECT * FROM equipamentos WHERE equipamento_id_cliente = $linha[0] and equipamento_lixeira ='1'  ";
$resultado2 = mysqli_query($conn, $sql2);
$totalequipamento = mysqli_num_rows($resultado2)
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class=""><?php echo $linha[10] ?></td>
                                        <td class=""><?php echo $linha[2] ?></td>
                                        <td class=""><?php echo $totalequipamento ?></td>
                                        <td class=""><i class="ri-checkbox-circle-line fs-17 align-middle"></i> Ativo</td>
                                        <td class="">
