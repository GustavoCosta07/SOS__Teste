...
if( isset( $_POST['image_upload'] ) && !empty( $_FILES['images'] )){
	...
	foreach ( $images as $key => $value){
		...
		if($image_flag){
			...
			$sql="INSERT INTO fotos (`original_image`, `thumbnail_image`, `foto_produto`) VALUES ('$name', '$thumbnail', '$_POST[produto]');";
...
<script>
    ...
    window.location.href = "add_foto_produto/<?php echo $_POST[produto] ?>";
</script>
<?php
